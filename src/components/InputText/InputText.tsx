...
const InputText = ({
	...
	return (
		<div className={`relative z-40 ${hidden ? "hidden" : ""}`}>
			<input
				type="text"
				className="select_style relative flex h-8 w-[200px] cursor-pointer items-center justify-between rounded-md border bg-neutral-800 px-3 py-2 pb-2 text-sm font-medium placeholder:italic placeholder:text-gray-200/30 focus:outline-none has-[input:disabled]:cursor-not-allowed has-[input:disabled]:opacity-50"
